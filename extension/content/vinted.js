...
(async () => {
  ...
  const CAT_HINTS = {
    ...
    // ── Boeken, speelgoed, fietsen, witgoed, klussen, computers, sport (24-09-2026) ──
    // Alleen de terugval: deze sleutels lopen eerst de boom af via V_PAD hieronder.
    "boeken gezondheid en voeding": ["non-fiction", "books"],
    "boeken kookboeken": ["non-fiction", "books"],
    "boeken geschiedenis regio": ["non-fiction", "books"],
    "boeken geschiedenis vaderland": ["non-fiction", "books"],
    "boeken geschiedenis wereld": ["non-fiction", "books"],
    "boeken historische romans": ["fiction", "books"],
    "boeken oorlog en militair": ["non-fiction", "books"],
    "boeken politiek en maatschappij": ["non-fiction", "books"],
    "boeken baby s en peuters": ["babies & toddlers", "kids & young adults"],
    "boeken kleuters": ["kids", "kids & young adults"],
    "boeken jeugd onder 10 jaar": ["kids", "kids & young adults"],
    "boeken jeugd 10 tot 12 jaar": ["kids", "kids & young adults"],
    "boeken jeugd 13 jaar en ouder": ["young adults", "kids & young adults"],
    "boeken film tv en media": ["non-fiction", "books"],
    "boeken architectuur": ["non-fiction", "books"],
    "boeken beeldend": ["non-fiction", "books"],
    "boeken dans en theater": ["non-fiction", "books"],
    "boeken fotografie en design": ["non-fiction", "books"],
    "boeken muziek": ["non-fiction", "books"],
    "boeken avontuur en actie": ["fiction", "books"],
    "boeken chicklit": ["fiction", "books"],
    "boeken detectives": ["fiction", "books"],
    "boeken literatuur": ["fiction", "books"],
    "boeken romans": ["fiction", "books"],
    "boeken fantasy": ["fiction", "books"],
    "boeken science fiction": ["fiction", "books"],
    "boeken sprookjes en fabels": ["fiction", "books"],
    "boeken thrillers": ["fiction", "books"],
    "boeken advies hulp en training": ["non-fiction", "books"],
    "boeken economie en marketing": ["non-fiction", "books"],
    "boeken encyclopedieen": ["non-fiction", "books"],
    "boeken esoterie en spiritualiteit": ["non-fiction", "books"],
    "boeken filosofie": ["non-fiction", "books"],
    "boeken godsdienst en theologie": ["non-fiction", "books"],
    "boeken informatica en computer": ["non-fiction", "books"],
    "boeken psychologie": ["non-fiction", "books"],
    "boeken schoolboeken": ["textbooks & study materials", "books"],
    "boeken studie en cursus": ["textbooks & study materials", "books"],
    "boeken techniek": ["non-fiction", "books"],
    "boeken wetenschap": ["non-fiction", "books"],
    "boeken zwangerschap en opvoeding": ["non-fiction", "books"],
    "boeken auto s boeken": ["non-fiction", "books"],
    "boeken auto s folders": ["non-fiction", "books"],
    "boeken auto s handleidingen": ["non-fiction", "books"],
    "boeken dieren en huisdieren": ["non-fiction", "books"],
    "boeken hobby en vrije tijd": ["non-fiction", "books"],
    "boeken mode": ["non-fiction", "books"],
    "boeken motoren": ["non-fiction", "books"],
    "boeken motoren handleidingen": ["non-fiction", "books"],
    "boeken natuur": ["non-fiction", "books"],
    "boeken sportboeken": ["non-fiction", "books"],
    "boeken vervoer en transport": ["non-fiction", "books"],
    "boeken wonen en tuinieren": ["non-fiction", "books"],
    "boeken stripboeken": ["comics, manga & graphic novels", "books"],
    "boeken comics": ["comics, manga & graphic novels", "books"],
    "boeken reisgidsen": ["non-fiction", "books"],
    "boeken reisverhalen": ["non-fiction", "books"],
    "boeken streekboeken en streekromans": ["fiction", "books"],
    "boeken taal duits": ["textbooks & study materials", "books"],
    "boeken taal engels": ["textbooks & study materials", "books"],
    "boeken taal frans": ["textbooks & study materials", "books"],
    "boeken taal spaans": ["textbooks & study materials", "books"],
    "boeken taal overige talen": ["textbooks & study materials", "books"],
    "boeken woordenboeken": ["non-fiction", "books"],
    "boeken antieke boeken en bijbels": ["non-fiction", "books"],
    "boeken atlassen en landkaarten": ["non-fiction", "books"],
    "boeken biografieen": ["non-fiction", "books"],
    "boeken boekenweekgeschenken": ["fiction", "books"],
    "boeken catalogussen en folders": ["non-fiction", "books"],
    "boeken essays en columns": ["non-fiction", "books"],
    "boeken gedichten en poezie": ["fiction", "books"],
    "boeken humor": ["non-fiction", "books"],
    "boeken partijen": ["books", "books & media"],
    "boeken prentenboeken en plaatjesalbums": ["kids", "kids & young adults"],
    "boeken tijdschriften en kranten": ["magazines", "books & media"],
    "boeken overige boeken": ["books", "books & media"],
    "speelgoed actiefiguren": ["figures", "toy figures & accessories"],
    "speelgoed babyspeelgoed": ["baby activities & toys", "toys"],
    "speelgoed badspeelgoed": ["bath toys", "baby activities & toys"],
    "speelgoed bouwstenen": ["blocks & building toys", "toys"],
    "speelgoed duplo en lego": ["blocks & building toys", "toys"],
    "speelgoed educatief en creatief": ["educational toys", "toys"],
    "speelgoed fisher-price": ["baby activities & toys", "toys"],
    "speelgoed houten speelgoed": ["toys", "kids"],
    "speelgoed kinderpuzzels": ["puzzles", "hobbies & collectables"],
    "speelgoed knuffels en pluche": ["soft toys & stuffed animals", "toys"],
    "speelgoed my little pony": ["figures", "toy figures & accessories"],
    "speelgoed playmobil": ["playsets", "toy figures & accessories"],
    "speelgoed poppen": ["dolls", "dolls & accessories"],
    "speelgoed poppenhuizen": ["dollhouses", "dolls & accessories"],
    "speelgoed racebanen": ["tracks & garages", "toy cars, trains & other vehicles"],
    "speelgoed speelgoedvoertuigen": ["toy cars, trains & other vehicles", "toys"],
    "speelgoed speelkeukens": ["toy kitchens", "dress up & pretend play"],
    "speelgoed speelkleden": ["baby gyms & activity mats", "baby activities & toys"],
    "speelgoed speeltafels": ["activity centres & baby walkers", "baby activities & toys"],
    "speelgoed speeltenten": ["play tents & tunnels", "dress up & pretend play"],
    "speelgoed thomas de trein": ["trains", "toy cars, trains & other vehicles"],
    "speelgoed voetbaltafels": ["table football tables", "table football"],
    "speelgoed vtech": ["electronic toys", "toys"],
    "speelgoed overig binnenspeelgoed": ["toys", "kids"],
    "speelgoed actiespeelgoed": ["outdoor & sports toys", "toys"],
    "speelgoed los buitenspeelgoed": ["outdoor & sports toys", "toys"],
    "speelgoed opblaasfiguren": ["beach & water toys", "outdoor & sports toys"],
    "speelgoed sleeen": ["sledging", "winter sports"],
    "speelgoed steps": ["scooters", "skateboards & scooters"],
    "speelgoed trampolines": ["outdoor trampolines", "casual sports & games"],
    "speelgoed voertuigen en loopfietsen": ["kids' bikes", "cycling"],
    "speelgoed zandbakken": ["sandpits & water tables", "outdoor & sports toys"],
    "speelgoed zwembaden": ["swimming pools", "spas, pools & equipment"],
    "speelgoed denksport en puzzels": ["puzzles", "hobbies & collectables"],
    "speelgoed bordspellen": ["board games", "hobbies & collectables"],
    "speelgoed kaartspellen": ["board games", "hobbies & collectables"],
    "speelgoed overige gezelschapsspellen": ["board games", "hobbies & collectables"],
    "speelgoed wargaming": ["tabletop & miniature gaming", "hobbies & collectables"],
    "speelgoed magic the gathering": ["trading cards", "hobbies & collectables"],
    "speelgoed pokemon": ["trading cards", "hobbies & collectables"],
    "speelgoed yu-gi-oh": ["trading cards", "hobbies & collectables"],
    "speelgoed overige verzamelkaartspellen": ["trading cards", "hobbies & collectables"],
    "speelgoed radiografisch auto s": ["remote control toys", "electronic toys"],
    "speelgoed radiografisch helikopters en quadcopters": ["remote control toys", "electronic toys"],
    "speelgoed radiografisch vliegtuigen": ["remote control toys", "electronic toys"],
    "speelgoed radiografisch overige": ["remote control toys", "electronic toys"],
    "speelgoed modelauto s schaal 1 5 tot 1 12": ["cars", "toy cars, trains & other vehicles"],
    "speelgoed modelauto s schaal 1 18": ["cars", "toy cars, trains & other vehicles"],
    "speelgoed modelauto s schaal 1 24": ["cars", "toy cars, trains & other vehicles"],
    "speelgoed modelauto s schaal 1 32": ["cars", "toy cars, trains & other vehicles"],
    "speelgoed modelauto s schaal 1 43": ["cars", "toy cars, trains & other vehicles"],
    "speelgoed modelauto s schaal 1 50": ["cars", "toy cars, trains & other vehicles"],
    "speelgoed modelauto s schaal 1 87": ["cars", "toy cars, trains & other vehicles"],
    "speelgoed modelauto s overige schalen": ["cars", "toy cars, trains & other vehicles"],
    "speelgoed modeltreinen h0": ["trains", "toy cars, trains & other vehicles"],
    "speelgoed modeltreinen n-spoor": ["trains", "toy cars, trains & other vehicles"],
    "speelgoed modeltreinen overige schalen": ["trains", "toy cars, trains & other vehicles"],
    "fietsen bakfietsen": ["cargo bikes", "bikes"],
    "fietsen crossfietsen en bmx": ["bmx bikes", "bikes"],
    "fietsen cruisers en lowriders": ["other bikes", "bikes"],
    "fietsen driewielfietsen": ["other bikes", "bikes"],
    "fietsen eenwielers": ["other bikes", "bikes"],
    "fietsen elektrische fietsen": ["electric bikes", "cycling"],
    "fietsen ligfietsen": ["other bikes", "bikes"],
    "fietsen mountainbikes en atb": ["mountain bikes", "bikes"],
    "fietsen oldtimers": ["other bikes", "bikes"],
    "fietsen racefietsen": ["road bikes", "bikes"],
    "fietsen tandems": ["other bikes", "bikes"],
    "fietsen vouwfietsen": ["folding bikes", "bikes"],
    "fietsen damesfietsen": ["city bikes", "bikes"],
    "fietsen moederfietsen": ["city bikes", "bikes"],
    "fietsen omafietsen": ["city bikes", "bikes"],
    "fietsen sportfietsen dames": ["hybrid bikes", "bikes"],
    "fietsen herenfietsen": ["city bikes", "bikes"],
    "fietsen sportfietsen heren": ["hybrid bikes", "bikes"],
    "fietsen driewielers": ["tricycles", "kids' bikes"],
    "fietsen jongensfietsen": ["kids' bikes"],
    "fietsen kinderfietsjes": ["kids' bikes"],
    "fietsen meisjesfietsen": ["kids' bikes"],
    "fietsen aanhangers en karren": ["bike trailers", "cycling"],
    "fietsen bagagedragers": ["bike pannier racks", "cycling accessories & tools"],
    "fietsen buggydragers": ["other bike accessories", "cycling accessories & tools"],
    "fietsen fietsaccu s": ["other bike parts", "bike parts"],
    "fietsen fietsbellen": ["bike bells & horns", "cycling accessories & tools"],
    "fietsen fietscomputers": ["other bike accessories", "cycling accessories & tools"],
    "fietsen fietsendragers": ["car bike racks", "cycling accessories & tools"],
    "fietsen fietsenrekken": ["bike stands & wall-mounts", "cycling accessories & tools"],
    "fietsen fietsgereedschap": ["bike tools", "cycling accessories & tools"],
    "fietsen fietshelmen": ["bike helmets", "cycling"],
    "fietsen fietsmanden": ["bike baskets", "cycling accessories & tools"],
    "fietsen fietsonderdelen": ["bike parts", "cycling"],
    "fietsen fietspompen": ["bike pumps", "cycling accessories & tools"],
    "fietsen fietssloten": ["bike locks", "cycling accessories & tools"],
    "fietsen fietsstoeltjes": ["kids' bike seats", "cycling"],
    "fietsen fietstassen": ["panniers & bike bags", "cycling accessories & tools"],
    "fietsen fietsverlichting": ["bike lights", "cycling accessories & tools"],
    "fietsen overige fietsaccessoires": ["other bike accessories", "cycling accessories & tools"],
    "fietsen overige fietsen": ["other bikes", "bikes"],
    "witgoed airco s": ["air conditioners", "heating, cooling & air"],
    "witgoed luchtbehandelingsapparatuur": ["heating, cooling & air", "household care"],
    "witgoed stofzuigers": ["vacuum cleaners", "vacuums & cleaning"],
    "witgoed stoomapparaten": ["steam cleaners", "vacuums & cleaning"],
    "witgoed strijkijzers en strijkplanken": ["irons & garment care", "household care"],
    "witgoed ventilatoren": ["fans", "heating, cooling & air"],
    "witgoed was-droogcombinaties": ["washing machines", "large appliances"],
    "witgoed wasdrogers": ["tumble dryers", "large appliances"],
    "witgoed wasmachines": ["washing machines", "large appliances"],
    "witgoed waterontharders": ["speciality large appliances", "large appliances"],
    "witgoed afzuigkappen": ["cooker hoods", "large appliances"],
    "witgoed airfryers": ["fryers", "small kitchen appliances"],
    "witgoed blenders": ["blenders", "blenders, mixers & food processors"],
    "witgoed broodbakmachines": ["speciality appliances", "small kitchen appliances"],
    "witgoed broodroosters": ["toasters", "small kitchen appliances"],
    "witgoed bruiswatermachines": ["soda makers", "water & drink dispensers"],
    "witgoed contactgrills": ["electric grills & griddles", "small kitchen appliances"],
    "witgoed eierkokers": ["speciality appliances", "small kitchen appliances"],
    "witgoed fonduesets": ["speciality appliances", "small kitchen appliances"],
    "witgoed fornuizen": ["ovens & cookers", "large appliances"],
    "witgoed frituurpannen": ["fryers", "small kitchen appliances"],
    "witgoed gourmetstellen": ["electric grills & griddles", "small kitchen appliances"],
    "witgoed grillplaten": ["electric grills & griddles", "small kitchen appliances"],
    "witgoed ijsmachines": ["speciality appliances", "small kitchen appliances"],
    "witgoed juicers": ["juicers", "small kitchen appliances"],
    "witgoed keukenmixers": ["blenders, mixers & food processors", "small kitchen appliances"],
    "witgoed koelkasten en ijskasten": ["fridges", "large appliances"],
    "witgoed koffiezetapparaten": ["coffee, tea & espresso making", "small kitchen appliances"],
    "witgoed koffiemachine-accessoires": ["coffee, tea & espresso tools", "coffee, tea & espresso making"],
    "witgoed kookplaten": ["ovens & cookers", "large appliances"],
    "witgoed magnetrons": ["microwaves", "small kitchen appliances"],
    "witgoed melkopschuimers": ["milk frothers", "coffee, tea & espresso making"],
    "witgoed ovens": ["ovens & cookers", "large appliances"],
    "witgoed rijstkokers": ["speciality appliances", "small kitchen appliances"],
    "witgoed slowcookers": ["speciality appliances", "small kitchen appliances"],
    "witgoed thuistaps": ["drink dispensers", "water & drink dispensers"],
    "witgoed vaatwasmachines": ["dishwashers", "large appliances"],
    "witgoed vriezers en diepvrieskisten": ["freezers", "large appliances"],
    "witgoed wafelijzers": ["speciality appliances", "small kitchen appliances"],
    "witgoed waterkoelers": ["drink dispensers", "water & drink dispensers"],
    "witgoed waterkokers": ["kettles", "small kitchen appliances"],
    "witgoed onderdelen en toebehoren": ["large appliance parts & accessories", "large appliances"],
    "witgoed persoonlijke verzorgingsapparatuur": ["beauty & personal care electronics", "electronics"],
    "witgoed weegschalen": ["personal scales", "beauty & personal care electronics"],
    "witgoed wekkers": ["clocks", "home accessories"],
    "klussen gereedschapskisten": ["tool boxes", "tool carrying & storage"],
    "klussen handgereedschap": ["hand tools", "tools & diy"],
    "klussen ladders en trappen": ["ladders", "workshop & worksite equipment"],
    "klussen meetapparatuur": ["measuring tools", "tools & diy"],
    "klussen werkbanken": ["workbenches", "workshop & worksite equipment"],
    "klussen boormachines": ["drills", "power tools"],
    "klussen compressors": ["air compressors", "power tools"],
    "klussen draaibanken": ["lathes", "power tools"],
    "klussen freesmachines": ["routers", "power tools"],
    "klussen hogedrukreinigers": ["pressure washers", "outdoor power tools"],
    "klussen lieren en takels": ["winches", "power tools"],
    "klussen onderdelen machines": ["tool accessories", "tools & diy"],
    "klussen schaafmachines": ["planers", "power tools"],
    "klussen schuurmachines": ["sanders", "power tools"],
    "klussen slijpmachines": ["grinders", "power tools"],
    "klussen zaagmachines": ["power saws", "power tools"],
    "klussen hang- en sluitwerk": ["hardware", "tools & diy"],
    "klussen zeil en folie": ["tarpaulins", "painting tools & accessories"],
    "klussen alarmsystemen": ["smart home & security", "tools & diy"],
    "klussen sanitair": ["bathroom fixtures", "hardware"],
    "klussen schildersmaterialen": ["painting tools & accessories", "tools & diy"],
    "klussen bouwverlichting": ["work lights", "workshop & worksite equipment"],
    "klussen verwarming en radiatoren": ["heaters & radiators", "heating, cooling & air"],
    "klussen gehoorbeschermers": ["hearing protection", "protective gear"],
    "klussen laskappen": ["face shields", "protective gear"],
    "klussen veiligheidsbrillen": ["safety glasses", "protective gear"],
    "klussen veiligheidshelmen": ["hard hats", "protective gear"],
    "computers barebones": ["desktop computers", "computers & accessories"],
    "computers computerbehuizingen": ["computer cases", "computer parts & components"],
    "computers computerkoelers": ["computer cooling & fans", "computer parts & components"],
    "computers geheugenkaartlezers": ["memory card readers", "computer accessories"],
    "computers geluidskaarten": ["internal sound cards", "computer parts & components"],
    "computers harde schijven": ["internal storage devices", "computer parts & components"],
    "computers interne voedingen": ["computer power supplies", "computer parts & components"],
    "computers moederborden": ["motherboards", "computer parts & components"],
    "computers nas": ["other computer accessories", "computer accessories"],
    "computers netwerkkaarten": ["network adaptors", "networking devices"],
    "computers processors": ["cpus & processors", "computer parts & components"],
    "computers ram geheugen": ["ram units", "computer parts & components"],
    "computers serverkasten": ["computer cases", "computer parts & components"],
    "computers videokaarten": ["graphics cards", "computer parts & components"],
    "computers apple desktops": ["desktop computers", "computers & accessories"],
    "computers desktop pc s": ["desktop computers", "computers & accessories"],
    "computers servers": ["desktop computers", "computers & accessories"],
    "computers vintage computers": ["desktop computers", "computers & accessories"],
    "computers laptop accu s": ["laptop replacement parts", "computer parts & components"],
    "computers apple macbooks": ["laptops", "computers & accessories"],
    "computers chromebooks": ["laptops", "computers & accessories"],
    "computers laptophoezen": ["laptop bags & cases", "laptop accessories"],
    "computers laptop-opladers": ["laptop chargers", "laptop accessories"],
    "computers laptopstandaarden": ["laptop stands", "laptop accessories"],
    "computers laptoptafels": ["laptop stands", "laptop accessories"],
    "computers laptoptassen": ["laptop bags & cases", "laptop accessories"],
    "computers windows laptops": ["laptops", "computers & accessories"],
    "computers accesspoints": ["networking devices", "computers & accessories"],
    "computers isdn en adsl": ["modems", "networking devices"],
    "computers netwerk switches": ["networking devices", "computers & accessories"],
    "computers pc- en netwerkkabels": ["cables", "other devices & accessories"],
    "computers powerlines": ["network adaptors", "networking devices"],
    "computers wifi-versterkers": ["network repeaters", "networking devices"],
    "computers beschrijfbare discs": ["cd, dvd & blu-ray discs", "blank media"],
    "computers usb sticks": ["usb flash drives", "blank media"],
    "computers labelprinters": ["label printers", "printers & accessories"],
    "computers pocketprinters": ["photo printers", "printers & accessories"],
    "computers printers": ["printers & accessories", "computers & accessories"],
    "computers printerbenodigdheden": ["printers & accessories", "computers & accessories"],
    "computers 3d printers": ["3d printers", "3d printing & scanning"],
    "computers 3d-printerbenodigheden": ["3d printing & scanning", "other devices & accessories"],
    "computers scanners": ["scanners", "scanners & accessories"],
    "computers capture cards": ["video capture & tv tuner cards", "computer parts & components"],
    "computers dockingstations": ["docking stations & usb hubs", "computers & accessories"],
    "computers headsets": ["headphones & earbuds", "audio, headphones & hi-fi"],
    "computers joysticks": ["controllers", "video games & consoles"],
    "computers monitoren": ["monitors", "monitors & accessories"],
    "computers muismatten": ["mouse pads", "computers & accessories"],
    "computers muizen": ["mice", "computers & accessories"],
    "computers noodvoedingen ups": ["batteries & power supplies", "other devices & accessories"],
    "computers optische drives": ["internal storage devices", "computer parts & components"],
    "computers pc speakers": ["computer speakers", "computers & accessories"],
    "computers presenters": ["other computer accessories", "computer accessories"],
    "computers routers en modems": ["networking devices", "computers & accessories"],
    "computers toetsenborden": ["keyboards", "keyboards & accessories"],
    "computers webcams": ["webcams", "computers & accessories"],
    "computers android tablets": ["tablets", "tablets, e-readers & accessories"],
    "computers apple ipads": ["tablets", "tablets, e-readers & accessories"],
    "computers e-readers": ["e-readers", "tablets, e-readers & accessories"],
    "computers tablet-hoezen": ["tablet cases & folios", "accessories"],
    "computers tekentablets": ["touch & stylus pads", "computers & accessories"],
    "computers windows tablets": ["tablets", "tablets, e-readers & accessories"],
    "sportartikelen badminton": ["badminton", "racket sports"],
    "sportartikelen basketbal": ["basketball", "team sports"],
    "sportartikelen bowlen": ["tenpin bowling", "casual sports & games"],
    "sportartikelen golf": ["golf", "sports"],
    "sportartikelen handbal": ["handball", "team sports"],
    "sportartikelen hockey": ["field hockey", "team sports"],
    "sportartikelen honkbal en softbal": ["baseball & softball", "team sports"],
    "sportartikelen korfbal": ["other team sports equipment", "team sports"],
    "sportartikelen padel": ["padel", "racket sports"],
    "sportartikelen rugby": ["rugby", "team sports"],
    "sportartikelen squash": ["squash", "racket sports"],
    "sportartikelen tafeltennis": ["table tennis", "racket sports"],
    "sportartikelen tennis": ["tennis", "racket sports"],
    "sportartikelen voetbal": ["football", "team sports"],
    "sportartikelen volleybal": ["volleyball", "team sports"],
    "sportartikelen fitnessapparatuur": ["exercise machines", "fitness, running & yoga"],
    "sportartikelen fitnessmaterialen": ["strength training", "fitness, running & yoga"],
    "sportartikelen turnen": ["home fitness accessories", "fitness, running & yoga"],
    "sportartikelen yoga en pilates": ["yoga & pilates equipment", "fitness, running & yoga"],
    "sportartikelen bergsport en wandelen": ["outdoor sports", "sports"],
    "sportartikelen klimsport": ["climbing & bouldering", "outdoor sports"],
    "sportartikelen loopsport en atletiek": ["running", "fitness, running & yoga"],
    "sportartikelen skateboarden": ["skateboards & scooters", "sports"],
    "sportartikelen wielrennen": ["cycling accessories & tools", "cycling"],
    "sportartikelen biljarten en poolen": ["pool & snooker", "casual sports & games"],
    "sportartikelen darts": ["darts equipment", "casual sports & games"],
    "sportartikelen handboogschieten": ["other outdoor sports accessories", "outdoor sports"],
    "sportartikelen paardrijkleding": ["equestrian", "sports"],
    "sportartikelen vliegeren": ["kites & rockets", "outdoor & sports toys"],
    "sportartikelen bidons": ["water bottles", "fitness, running & yoga"],
    "sportartikelen hartslagmeters": ["fitness trackers", "wearables"],
    "sportartikelen hoelahoeps": ["weighted hoops", "home fitness accessories"],
    "sportartikelen springtouwen": ["skipping ropes", "home fitness accessories"],
    "sportartikelen boksen": ["boxing & martial arts", "sports"],
    "sportartikelen vechtsporten en zelfverdediging": ["boxing & martial arts", "sports"],
    "sportartikelen duiken": ["swimming", "water sports"],
    "sportartikelen golfsurfen": ["surfboards", "water sports"],
    "sportartikelen kitesurfen": ["kitesurf boards", "water sports"],
    "sportartikelen snorkelen": ["swimming", "water sports"],
    "sportartikelen suppen": ["stand-up paddle boards", "water sports"],
    "sportartikelen wakeboarden": ["wakeboards", "water sports"],
    "sportartikelen waterpolo": ["water sports accessories", "water sports"],
    "sportartikelen waterski s": ["water skis", "water sports"],
    "sportartikelen windsurfen": ["water sports accessories", "water sports"],
    "sportartikelen wingsurfen": ["water sports accessories", "water sports"],
    "sportartikelen massageproducten": ["massage tools", "beauty & personal care electronics"],
    "sportartikelen sauna": ["saunas", "spas, pools & equipment"],
    "sportartikelen ijshockey": ["ice hockey", "winter sports"],
    "sportartikelen skien en langlaufen": ["ski equipment", "winter sports"],
    "sportartikelen snowboarden": ["snowboard equipment", "winter sports"],
    "games accessoires nintendo console": ["accessories", "video games & consoles"],
    "games accessoires nintendo portable": ["accessories", "video games & consoles"],
    "games accessoires playstation console": ["accessories", "video games & consoles"],
    "games accessoires playstation portable": ["accessories", "video games & consoles"],
    "games accessoires xbox": ["accessories", "video games & consoles"],
    "games accessoires overige": ["accessories", "video games & consoles"],
    "games controllers nintendo": ["controllers", "video games & consoles"],
    "games controllers playstation": ["controllers", "video games & consoles"],
    "games controllers xbox": ["controllers", "video games & consoles"],
    "games virtual reality": ["virtual reality", "video games & consoles"],
    "electronics telefoon sagem": ["mobile phones", "mobile phones & communication"],
    "electronics telefoon siemens": ["mobile phones", "mobile phones & communication"],
    "electronics telefoon pda s": ["pdas", "tablets, e-readers & accessories"],
    "electronics hoesjes apple iphone": ["mobile phone cases", "mobile phone parts & accessories"],
    "electronics hoesjes blackberry": ["mobile phone cases", "mobile phone parts & accessories"],
    "electronics hoesjes htc": ["mobile phone cases", "mobile phone parts & accessories"],
    "electronics hoesjes nokia": ["mobile phone cases", "mobile phone parts & accessories"],
    "electronics hoesjes samsung": ["mobile phone cases", "mobile phone parts & accessories"],
    "electronics hoesjes overige merken": ["mobile phone cases", "mobile phone parts & accessories"],
    "electronics powerbanks": ["power banks", "other devices & accessories"],
    "electronics autoladers": ["chargers", "other devices & accessories"],
    "electronics batterijen en accu s": ["mobile phone parts", "mobile phone parts & accessories"],
    "electronics oordopjes": ["headphones & earbuds", "audio, headphones & hi-fi"],
    "electronics pda-toebehoren": ["other mobile phone accessories", "mobile phone parts & accessories"],
    "electronics telefoon-opladers": ["chargers", "other devices & accessories"],
    "electronics telefoonhouders": ["mobile phone mounts & stands", "mobile phone parts & accessories"],
    "electronics toebehoren en onderdelen": ["mobile phone parts", "mobile phone parts & accessories"],
    "electronics antwoordapparaten": ["landline phones", "mobile phones & communication"],
    "electronics draadloze handsets": ["landline phones", "mobile phones & communication"],
    "electronics niet-draadloze handsets": ["landline phones", "mobile phones & communication"],
    "electronics wearable-accessoires": ["wearables", "electronics"],
    "electronics faxen": ["fax machines", "mobile phones & communication"],
    "electronics portofoons en walkie-talkies": ["walkie-talkies", "radio communication"],
  };

  // EXACTE VINTED-PADEN VOOR DE TAKKEN BUITEN KLEDING (24-09-2026).
  //
  // Boeken, speelgoed, fietsen, witgoed, klussen, computers, sport, plus de
  // accessoires bij games en telefoons. Elk pad is letterlijk nagelopen in
  // Vinteds eigen categorieboom (/api/v2/item_upload/catalogs op vinted.nl): elke
  // stap bestaat zo. Stopt een pad bij een tussenlaag, dan kiest de boomwandeling
  // het blad daaronder zoals bij kleding: woorden uit de titel, Vinteds eigen
  // voorstel uit de foto's, en anders het neutrale "Other …".
  //
  // null betekent: Vinted heeft hier geen rubriek voor (bouwmaterialen, software,
  // zonnebanken, simkaarten). Dan gokt de extensie niets bij elkaar maar stopt ze
  // met een duidelijke melding; de server houdt zulke artikelen ook al tegen
  // (NIET_OP_VINTED in backend/services/platformregels.py).
  const V_PAD = {
    "boeken gezondheid en voeding": ["Books & Media", "Books", "Non-fiction"],
    "boeken kookboeken": ["Books & Media", "Books", "Non-fiction"],
    "boeken geschiedenis regio": ["Books & Media", "Books", "Non-fiction"],
    "boeken geschiedenis vaderland": ["Books & Media", "Books", "Non-fiction"],
    "boeken geschiedenis wereld": ["Books & Media", "Books", "Non-fiction"],
    "boeken historische romans": ["Books & Media", "Books", "Fiction"],
    "boeken oorlog en militair": ["Books & Media", "Books", "Non-fiction"],
    "boeken politiek en maatschappij": ["Books & Media", "Books", "Non-fiction"],
    "boeken baby s en peuters": ["Books & Media", "Books", "Kids & young adults", "Babies & toddlers"],
    "boeken kleuters": ["Books & Media", "Books", "Kids & young adults", "Kids"],
    "boeken jeugd onder 10 jaar": ["Books & Media", "Books", "Kids & young adults", "Kids"],
    "boeken jeugd 10 tot 12 jaar": ["Books & Media", "Books", "Kids & young adults", "Kids"],
    "boeken jeugd 13 jaar en ouder": ["Books & Media", "Books", "Kids & young adults", "Young adults"],
    "boeken film tv en media": ["Books & Media", "Books", "Non-fiction"],
    "boeken architectuur": ["Books & Media", "Books", "Non-fiction"],
    "boeken beeldend": ["Books & Media", "Books", "Non-fiction"],
    "boeken dans en theater": ["Books & Media", "Books", "Non-fiction"],
    "boeken fotografie en design": ["Books & Media", "Books", "Non-fiction"],
    "boeken muziek": ["Books & Media", "Books", "Non-fiction"],
    "boeken avontuur en actie": ["Books & Media", "Books", "Fiction"],
    "boeken chicklit": ["Books & Media", "Books", "Fiction"],
    "boeken detectives": ["Books & Media", "Books", "Fiction"],
    "boeken literatuur": ["Books & Media", "Books", "Fiction"],
    "boeken romans": ["Books & Media", "Books", "Fiction"],
    "boeken fantasy": ["Books & Media", "Books", "Fiction"],
    "boeken science fiction": ["Books & Media", "Books", "Fiction"],
    "boeken sprookjes en fabels": ["Books & Media", "Books", "Fiction"],
    "boeken thrillers": ["Books & Media", "Books", "Fiction"],
    "boeken advies hulp en training": ["Books & Media", "Books", "Non-fiction"],
    "boeken economie en marketing": ["Books & Media", "Books", "Non-fiction"],
    "boeken encyclopedieen": ["Books & Media", "Books", "Non-fiction"],
    "boeken esoterie en spiritualiteit": ["Books & Media", "Books", "Non-fiction"],
    "boeken filosofie": ["Books & Media", "Books", "Non-fiction"],
    "boeken godsdienst en theologie": ["Books & Media", "Books", "Non-fiction"],
    "boeken informatica en computer": ["Books & Media", "Books", "Non-fiction"],
    "boeken psychologie": ["Books & Media", "Books", "Non-fiction"],
    "boeken schoolboeken": ["Books & Media", "Books", "Textbooks & study materials"],
    "boeken studie en cursus": ["Books & Media", "Books", "Textbooks & study materials"],
    "boeken techniek": ["Books & Media", "Books", "Non-fiction"],
    "boeken wetenschap": ["Books & Media", "Books", "Non-fiction"],
    "boeken zwangerschap en opvoeding": ["Books & Media", "Books", "Non-fiction"],
    "boeken auto s boeken": ["Books & Media", "Books", "Non-fiction"],
    "boeken auto s folders": ["Books & Media", "Books", "Non-fiction"],
    "boeken auto s handleidingen": ["Books & Media", "Books", "Non-fiction"],
    "boeken dieren en huisdieren": ["Books & Media", "Books", "Non-fiction"],
    "boeken hobby en vrije tijd": ["Books & Media", "Books", "Non-fiction"],
    "boeken mode": ["Books & Media", "Books", "Non-fiction"],
    "boeken motoren": ["Books & Media", "Books", "Non-fiction"],
    "boeken motoren handleidingen": ["Books & Media", "Books", "Non-fiction"],
    "boeken natuur": ["Books & Media", "Books", "Non-fiction"],
    "boeken sportboeken": ["Books & Media", "Books", "Non-fiction"],
    "boeken vervoer en transport": ["Books & Media", "Books", "Non-fiction"],
    "boeken wonen en tuinieren": ["Books & Media", "Books", "Non-fiction"],
    "boeken stripboeken": ["Books & Media", "Books", "Comics, manga & graphic novels"],
    "boeken comics": ["Books & Media", "Books", "Comics, manga & graphic novels"],
    "boeken reisgidsen": ["Books & Media", "Books", "Non-fiction"],
    "boeken reisverhalen": ["Books & Media", "Books", "Non-fiction"],
    "boeken streekboeken en streekromans": ["Books & Media", "Books", "Fiction"],
    "boeken taal duits": ["Books & Media", "Books", "Textbooks & study materials"],
    "boeken taal engels": ["Books & Media", "Books", "Textbooks & study materials"],
    "boeken taal frans": ["Books & Media", "Books", "Textbooks & study materials"],
    "boeken taal spaans": ["Books & Media", "Books", "Textbooks & study materials"],
    "boeken taal overige talen": ["Books & Media", "Books", "Textbooks & study materials"],
    "boeken woordenboeken": ["Books & Media", "Books", "Non-fiction"],
    "boeken antieke boeken en bijbels": ["Books & Media", "Books", "Non-fiction"],
    "boeken atlassen en landkaarten": ["Books & Media", "Books", "Non-fiction"],
    "boeken biografieen": ["Books & Media", "Books", "Non-fiction"],
    "boeken boekenweekgeschenken": ["Books & Media", "Books", "Fiction"],
    "boeken catalogussen en folders": ["Books & Media", "Books", "Non-fiction"],
    "boeken e-books": null,
    "boeken essays en columns": ["Books & Media", "Books", "Non-fiction"],
    "boeken gedichten en poezie": ["Books & Media", "Books", "Fiction"],
    "boeken humor": ["Books & Media", "Books", "Non-fiction"],
    "boeken luisterboeken": null,
    "boeken partijen": ["Books & Media", "Books"],
    "boeken prentenboeken en plaatjesalbums": ["Books & Media", "Books", "Kids & young adults", "Kids"],
    "boeken tijdschriften en kranten": ["Books & Media", "Magazines"],
    "boeken overige boeken": ["Books & Media", "Books"],
    "speelgoed actiefiguren": ["Kids", "Toys", "Toy figures & accessories", "Figures"],
    "speelgoed babyspeelgoed": ["Kids", "Toys", "Baby activities & toys"],
    "speelgoed badspeelgoed": ["Kids", "Toys", "Baby activities & toys", "Bath toys"],
    "speelgoed bouwstenen": ["Kids", "Toys", "Blocks & building toys"],
    "speelgoed duplo en lego": ["Kids", "Toys", "Blocks & building toys"],
    "speelgoed educatief en creatief": ["Kids", "Toys", "Educational toys"],
    "speelgoed fisher-price": ["Kids", "Toys", "Baby activities & toys"],
    "speelgoed hobbelfiguren": null,
    "speelgoed houten speelgoed": ["Kids", "Toys"],
    "speelgoed kinderpuzzels": ["Hobbies & collectables", "Puzzles"],
    "speelgoed knuffels en pluche": ["Kids", "Toys", "Soft toys & stuffed animals"],
    "speelgoed my little pony": ["Kids", "Toys", "Toy figures & accessories", "Figures"],
    "speelgoed playmobil": ["Kids", "Toys", "Toy figures & accessories", "Playsets"],
    "speelgoed poppen": ["Kids", "Toys", "Dolls & accessories", "Dolls"],
    "speelgoed poppenhuizen": ["Kids", "Toys", "Dolls & accessories", "Dollhouses"],
    "speelgoed racebanen": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Tracks & garages"],
    "speelgoed speelgoedvoertuigen": ["Kids", "Toys", "Toy cars, trains & other vehicles"],
    "speelgoed speelhuisjes": null,
    "speelgoed speelkeukens": ["Kids", "Toys", "Dress up & pretend play", "Toy kitchens"],
    "speelgoed speelkleden": ["Kids", "Toys", "Baby activities & toys", "Baby gyms & activity mats"],
    "speelgoed speeltafels": ["Kids", "Toys", "Baby activities & toys", "Activity centres & baby walkers"],
    "speelgoed speeltenten": ["Kids", "Toys", "Dress up & pretend play", "Play tents & tunnels"],
    "speelgoed thomas de trein": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Trains"],
    "speelgoed voetbaltafels": ["Sports", "Casual sports & games", "Table football", "Table football tables"],
    "speelgoed vtech": ["Kids", "Toys", "Electronic toys"],
    "speelgoed overig binnenspeelgoed": ["Kids", "Toys"],
    "speelgoed accuvoertuigen": null,
    "speelgoed actiespeelgoed": ["Kids", "Toys", "Outdoor & sports toys"],
    "speelgoed los buitenspeelgoed": ["Kids", "Toys", "Outdoor & sports toys"],
    "speelgoed opblaasfiguren": ["Kids", "Toys", "Outdoor & sports toys", "Beach & water toys"],
    "speelgoed rolschaatsen": null,
    "speelgoed skelters": null,
    "speelgoed sleeen": ["Sports", "Winter sports", "Sledging"],
    "speelgoed speeltoestellen": null,
    "speelgoed springkussens": null,
    "speelgoed steps": ["Sports", "Skateboards & scooters", "Scooters"],
    "speelgoed trampolines": ["Sports", "Casual sports & games", "Outdoor trampolines"],
    "speelgoed voertuigen en loopfietsen": ["Sports", "Cycling", "Kids' bikes"],
    "speelgoed zandbakken": ["Kids", "Toys", "Outdoor & sports toys", "Sandpits & water tables"],
    "speelgoed zwembaden": ["Home", "Outdoor & garden", "Spas, pools & equipment", "Swimming pools"],
    "speelgoed denksport en puzzels": ["Hobbies & collectables", "Puzzles"],
    "speelgoed bordspellen": ["Hobbies & collectables", "Board games"],
    "speelgoed kaartspellen": ["Hobbies & collectables", "Board games"],
    "speelgoed overige gezelschapsspellen": ["Hobbies & collectables", "Board games"],
    "speelgoed wargaming": ["Hobbies & collectables", "Tabletop & miniature gaming"],
    "speelgoed magic the gathering": ["Hobbies & collectables", "Trading cards"],
    "speelgoed pokemon": ["Hobbies & collectables", "Trading cards"],
    "speelgoed yu-gi-oh": ["Hobbies & collectables", "Trading cards"],
    "speelgoed overige verzamelkaartspellen": ["Hobbies & collectables", "Trading cards"],
    "speelgoed modelbouw auto s en voertuigen": null,
    "speelgoed modelbouw boten en schepen": null,
    "speelgoed modelbouw figuren en diorama s": null,
    "speelgoed modelbouw vliegtuigen en helikopters": null,
    "speelgoed modelbouw overige": null,
    "speelgoed radiografisch auto s": ["Kids", "Toys", "Electronic toys", "Remote control toys"],
    "speelgoed radiografisch helikopters en quadcopters": ["Kids", "Toys", "Electronic toys", "Remote control toys"],
    "speelgoed radiografisch vliegtuigen": ["Kids", "Toys", "Electronic toys", "Remote control toys"],
    "speelgoed radiografisch overige": ["Kids", "Toys", "Electronic toys", "Remote control toys"],
    "speelgoed modelauto s schaal 1 5 tot 1 12": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Cars"],
    "speelgoed modelauto s schaal 1 18": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Cars"],
    "speelgoed modelauto s schaal 1 24": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Cars"],
    "speelgoed modelauto s schaal 1 32": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Cars"],
    "speelgoed modelauto s schaal 1 43": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Cars"],
    "speelgoed modelauto s schaal 1 50": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Cars"],
    "speelgoed modelauto s schaal 1 87": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Cars"],
    "speelgoed modelauto s overige schalen": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Cars"],
    "speelgoed modeltreinen h0": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Trains"],
    "speelgoed modeltreinen n-spoor": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Trains"],
    "speelgoed modeltreinen overige schalen": ["Kids", "Toys", "Toy cars, trains & other vehicles", "Trains"],
    "fietsen bakfietsen": ["Sports", "Cycling", "Bikes", "Cargo bikes"],
    "fietsen crossfietsen en bmx": ["Sports", "Cycling", "Bikes", "BMX bikes"],
    "fietsen cruisers en lowriders": ["Sports", "Cycling", "Bikes", "Other bikes"],
    "fietsen driewielfietsen": ["Sports", "Cycling", "Bikes", "Other bikes"],
    "fietsen eenwielers": ["Sports", "Cycling", "Bikes", "Other bikes"],
    "fietsen elektrische fietsen": ["Sports", "Cycling", "Electric bikes"],
    "fietsen ligfietsen": ["Sports", "Cycling", "Bikes", "Other bikes"],
    "fietsen mountainbikes en atb": ["Sports", "Cycling", "Bikes", "Mountain bikes"],
    "fietsen oldtimers": ["Sports", "Cycling", "Bikes", "Other bikes"],
    "fietsen racefietsen": ["Sports", "Cycling", "Bikes", "Road bikes"],
    "fietsen tandems": ["Sports", "Cycling", "Bikes", "Other bikes"],
    "fietsen vouwfietsen": ["Sports", "Cycling", "Bikes", "Folding bikes"],
    "fietsen damesfietsen": ["Sports", "Cycling", "Bikes", "City bikes"],
    "fietsen moederfietsen": ["Sports", "Cycling", "Bikes", "City bikes"],
    "fietsen omafietsen": ["Sports", "Cycling", "Bikes", "City bikes"],
    "fietsen sportfietsen dames": ["Sports", "Cycling", "Bikes", "Hybrid bikes"],
    "fietsen herenfietsen": ["Sports", "Cycling", "Bikes", "City bikes"],
    "fietsen sportfietsen heren": ["Sports", "Cycling", "Bikes", "Hybrid bikes"],
    "fietsen driewielers": ["Sports", "Cycling", "Kids' bikes", "Tricycles"],
    "fietsen jongensfietsen": ["Sports", "Cycling", "Kids' bikes", "Kids' bikes"],
    "fietsen kinderfietsjes": ["Sports", "Cycling", "Kids' bikes", "Kids' bikes"],
    "fietsen meisjesfietsen": ["Sports", "Cycling", "Kids' bikes", "Kids' bikes"],
    "fietsen aanhangers en karren": ["Sports", "Cycling", "Bike trailers"],
    "fietsen bagagedragers": ["Sports", "Cycling", "Cycling accessories & tools", "Bike pannier racks"],
    "fietsen buggydragers": ["Sports", "Cycling", "Cycling accessories & tools", "Other bike accessories"],
    "fietsen fietsaccu s": ["Sports", "Cycling", "Bike parts", "Other bike parts"],
    "fietsen fietsbellen": ["Sports", "Cycling", "Cycling accessories & tools", "Bike bells & horns"],
    "fietsen fietscomputers": ["Sports", "Cycling", "Cycling accessories & tools", "Other bike accessories"],
    "fietsen fietsendragers": ["Sports", "Cycling", "Cycling accessories & tools", "Car bike racks"],
    "fietsen fietsenrekken": ["Sports", "Cycling", "Cycling accessories & tools", "Bike stands & wall-mounts"],
    "fietsen fietsgereedschap": ["Sports", "Cycling", "Cycling accessories & tools", "Bike tools"],
    "fietsen fietshelmen": ["Sports", "Cycling", "Bike helmets"],
    "fietsen fietsmanden": ["Sports", "Cycling", "Cycling accessories & tools", "Bike baskets"],
    "fietsen fietsonderdelen": ["Sports", "Cycling", "Bike parts"],
    "fietsen fietspompen": ["Sports", "Cycling", "Cycling accessories & tools", "Bike pumps"],
    "fietsen fietssloten": ["Sports", "Cycling", "Cycling accessories & tools", "Bike locks"],
    "fietsen fietsstoeltjes": ["Sports", "Cycling", "Kids' bike seats"],
    "fietsen fietstassen": ["Sports", "Cycling", "Cycling accessories & tools", "Panniers & bike bags"],
    "fietsen fietsverlichting": ["Sports", "Cycling", "Cycling accessories & tools", "Bike lights"],
    "fietsen overige fietsaccessoires": ["Sports", "Cycling", "Cycling accessories & tools", "Other bike accessories"],
    "fietsen overige fietsen": ["Sports", "Cycling", "Bikes", "Other bikes"],
    "witgoed airco s": ["Home", "Household care", "Heating, cooling & air", "Air conditioners"],
    "witgoed luchtbehandelingsapparatuur": ["Home", "Household care", "Heating, cooling & air"],
    "witgoed stofzuigers": ["Home", "Household care", "Vacuums & cleaning", "Vacuum cleaners"],
    "witgoed stoomapparaten": ["Home", "Household care", "Vacuums & cleaning", "Steam cleaners"],
    "witgoed strijkijzers en strijkplanken": ["Home", "Household care", "Irons & garment care"],
    "witgoed ventilatoren": ["Home", "Household care", "Heating, cooling & air", "Fans"],
    "witgoed was-droogcombinaties": ["Home", "Large appliances", "Washing machines"],
    "witgoed wasdrogers": ["Home", "Large appliances", "Tumble dryers"],
    "witgoed wasmachines": ["Home", "Large appliances", "Washing machines"],
    "witgoed waterontharders": ["Home", "Large appliances", "Speciality large appliances"],
    "witgoed afzuigkappen": ["Home", "Large appliances", "Cooker hoods"],
    "witgoed airfryers": ["Home", "Small kitchen appliances", "Fryers"],
    "witgoed blenders": ["Home", "Small kitchen appliances", "Blenders, mixers & food processors", "Blenders"],
    "witgoed broodbakmachines": ["Home", "Small kitchen appliances", "Speciality appliances"],
    "witgoed broodroosters": ["Home", "Small kitchen appliances", "Toasters"],
    "witgoed bruiswatermachines": ["Home", "Small kitchen appliances", "Water & drink dispensers", "Soda makers"],
    "witgoed contactgrills": ["Home", "Small kitchen appliances", "Electric grills & griddles"],
    "witgoed eierkokers": ["Home", "Small kitchen appliances", "Speciality appliances"],
    "witgoed fonduesets": ["Home", "Small kitchen appliances", "Speciality appliances"],
    "witgoed fornuizen": ["Home", "Large appliances", "Ovens & cookers"],
    "witgoed frituurpannen": ["Home", "Small kitchen appliances", "Fryers"],
    "witgoed gourmetstellen": ["Home", "Small kitchen appliances", "Electric grills & griddles"],
    "witgoed grillplaten": ["Home", "Small kitchen appliances", "Electric grills & griddles"],
    "witgoed ijsmachines": ["Home", "Small kitchen appliances", "Speciality appliances"],
    "witgoed juicers": ["Home", "Small kitchen appliances", "Juicers"],
    "witgoed keukenmixers": ["Home", "Small kitchen appliances", "Blenders, mixers & food processors"],
    "witgoed koelkasten en ijskasten": ["Home", "Large appliances", "Fridges"],
    "witgoed koffiezetapparaten": ["Home", "Small kitchen appliances", "Coffee, tea & espresso making"],
    "witgoed koffiemachine-accessoires": ["Home", "Small kitchen appliances", "Coffee, tea & espresso making", "Coffee, tea & espresso tools"],
    "witgoed kookplaten": ["Home", "Large appliances", "Ovens & cookers"],
    "witgoed magnetrons": ["Home", "Small kitchen appliances", "Microwaves"],
    "witgoed melkopschuimers": ["Home", "Small kitchen appliances", "Coffee, tea & espresso making", "Milk frothers"],
    "witgoed ovens": ["Home", "Large appliances", "Ovens & cookers"],
    "witgoed rijstkokers": ["Home", "Small kitchen appliances", "Speciality appliances"],
    "witgoed slowcookers": ["Home", "Small kitchen appliances", "Speciality appliances"],
    "witgoed thuistaps": ["Home", "Small kitchen appliances", "Water & drink dispensers", "Drink dispensers"],
    "witgoed vaatwasmachines": ["Home", "Large appliances", "Dishwashers"],
    "witgoed vriezers en diepvrieskisten": ["Home", "Large appliances", "Freezers"],
    "witgoed wafelijzers": ["Home", "Small kitchen appliances", "Speciality appliances"],
    "witgoed waterkoelers": ["Home", "Small kitchen appliances", "Water & drink dispensers", "Drink dispensers"],
    "witgoed waterkokers": ["Home", "Small kitchen appliances", "Kettles"],
    "witgoed onderdelen en toebehoren": ["Home", "Large appliances", "Large appliance parts & accessories"],
    "witgoed persoonlijke verzorgingsapparatuur": ["Electronics", "Beauty & personal care electronics"],
    "witgoed weegschalen": ["Electronics", "Beauty & personal care electronics", "Personal scales"],
    "witgoed wekkers": ["Home", "Home accessories", "Clocks"],
    "witgoed zonnebanken en gezichtsbruiners": null,
    "witgoed overige witgoed en apparatuur": null,
    "klussen steigers": null,
    "klussen dakbedekking": null,
    "klussen gereedschapskisten": ["Home", "Tools & DIY", "Tool carrying & storage", "Tool boxes"],
    "klussen handgereedschap": ["Home", "Tools & DIY", "Hand tools"],
    "klussen kruiwagens": null,
    "klussen ladders en trappen": ["Home", "Tools & DIY", "Workshop & worksite equipment", "Ladders"],
    "klussen meetapparatuur": ["Home", "Tools & DIY", "Measuring tools"],
    "klussen tekentafels": null,
    "klussen transportwagens": null,
    "klussen werkbanken": ["Home", "Tools & DIY", "Workshop & worksite equipment", "Workbenches"],
    "klussen betonmolens": null,
    "klussen boormachines": ["Home", "Tools & DIY", "Power tools", "Drills"],
    "klussen compressors": ["Home", "Tools & DIY", "Power tools", "Air compressors"],
    "klussen draaibanken": ["Home", "Tools & DIY", "Power tools", "Lathes"],
    "klussen freesmachines": ["Home", "Tools & DIY", "Power tools", "Routers"],
    "klussen hogedrukreinigers": ["Home", "Outdoor & garden", "Outdoor power tools", "Pressure washers"],
    "klussen lasapparaten": null,
    "klussen lieren en takels": ["Home", "Tools & DIY", "Power tools", "Winches"],
    "klussen motoren": null,
    "klussen onderdelen machines": ["Home", "Tools & DIY", "Tool accessories"],
    "klussen reinigingsmachines": null,
    "klussen schaafmachines": ["Home", "Tools & DIY", "Power tools", "Planers"],
    "klussen schuurmachines": ["Home", "Tools & DIY", "Power tools", "Sanders"],
    "klussen slijpmachines": ["Home", "Tools & DIY", "Power tools", "Grinders"],
    "klussen weegschalen": null,
    "klussen zaagmachines": ["Home", "Tools & DIY", "Power tools", "Power saws"],
    "klussen overige machines": null,
    "klussen buizen en afvoer": null,
    "klussen hang- en sluitwerk": ["Home", "Tools & DIY", "Hardware"],
    "klussen hout en planken": null,
    "klussen ijzerwaren en bevestigingsmiddelen": null,
    "klussen isolatie en afdichting": null,
    "klussen kratten en dozen": null,
    "klussen metalen": null,
    "klussen metselstenen": null,
    "klussen platen en panelen": null,
    "klussen plinten en afwerking": null,
    "klussen vloerdelen en plavuizen": null,
    "klussen zeil en folie": ["Home", "Tools & DIY", "Painting tools & accessories", "Tarpaulins"],
    "klussen zwenkwielen": null,
    "klussen alarmsystemen": ["Home", "Tools & DIY", "Smart home & security"],
    "klussen deuren en horren": null,
    "klussen glas en ramen": null,
    "klussen kozijnen en schuifpuien": null,
    "klussen rolluiken": null,
    "klussen sanitair": ["Home", "Tools & DIY", "Hardware", "Bathroom fixtures"],
    "klussen tegels": null,
    "klussen schildersmaterialen": ["Home", "Tools & DIY", "Painting tools & accessories"],
    "klussen verf beits en lak": null,
    "klussen bouwverlichting": ["Home", "Tools & DIY", "Workshop & worksite equipment", "Work lights"],
    "klussen elektra en kabels": null,
    "klussen geisers en boilers": null,
    "klussen thermostaten": null,
    "klussen ventilatie en afzuiging": null,
    "klussen verwarming en radiatoren": ["Home", "Household care", "Heating, cooling & air", "Heaters & radiators"],
    "klussen adembescherming": null,
    "klussen gehoorbeschermers": ["Home", "Tools & DIY", "Protective gear", "Hearing protection"],
    "klussen laskappen": ["Home", "Tools & DIY", "Protective gear", "Face shields"],
    "klussen veiligheidsbrillen": ["Home", "Tools & DIY", "Protective gear", "Safety glasses"],
    "klussen veiligheidshelmen": ["Home", "Tools & DIY", "Protective gear", "Hard hats"],
    "klussen veiligheidskleding": null,
    "klussen werkkleding": null,
    "klussen overige doe-het-zelf en verbouw": null,
    "computers barebones": ["Electronics", "Computers & accessories", "Desktop computers"],
    "computers computerbehuizingen": ["Electronics", "Computers & accessories", "Computer parts & components", "Computer cases"],
    "computers computerkoelers": ["Electronics", "Computers & accessories", "Computer parts & components", "Computer cooling & fans"],
    "computers geheugenkaartlezers": ["Electronics", "Computers & accessories", "Computer accessories", "Memory card readers"],
    "computers geluidskaarten": ["Electronics", "Computers & accessories", "Computer parts & components", "Internal sound cards"],
    "computers harde schijven": ["Electronics", "Computers & accessories", "Computer parts & components", "Internal storage devices"],
    "computers interne voedingen": ["Electronics", "Computers & accessories", "Computer parts & components", "Computer power supplies"],
    "computers moederborden": ["Electronics", "Computers & accessories", "Computer parts & components", "Motherboards"],
    "computers nas": ["Electronics", "Computers & accessories", "Computer accessories", "Other computer accessories"],
    "computers netwerkkaarten": ["Electronics", "Computers & accessories", "Networking devices", "Network adaptors"],
    "computers processors": ["Electronics", "Computers & accessories", "Computer parts & components", "CPUs & processors"],
    "computers ram geheugen": ["Electronics", "Computers & accessories", "Computer parts & components", "RAM units"],
    "computers serverkasten": ["Electronics", "Computers & accessories", "Computer parts & components", "Computer cases"],
    "computers videokaarten": ["Electronics", "Computers & accessories", "Computer parts & components", "Graphics cards"],
    "computers apple desktops": ["Electronics", "Computers & accessories", "Desktop computers"],
    "computers desktop pc s": ["Electronics", "Computers & accessories", "Desktop computers"],
    "computers servers": ["Electronics", "Computers & accessories", "Desktop computers"],
    "computers vintage computers": ["Electronics", "Computers & accessories", "Desktop computers"],
    "computers laptop accu s": ["Electronics", "Computers & accessories", "Computer parts & components", "Laptop replacement parts"],
    "computers apple macbooks": ["Electronics", "Computers & accessories", "Laptops"],
    "computers chromebooks": ["Electronics", "Computers & accessories", "Laptops"],
    "computers laptophoezen": ["Electronics", "Computers & accessories", "Laptop accessories", "Laptop bags & cases"],
    "computers laptop-opladers": ["Electronics", "Computers & accessories", "Laptop accessories", "Laptop chargers"],
    "computers laptopstandaarden": ["Electronics", "Computers & accessories", "Laptop accessories", "Laptop stands"],
    "computers laptoptafels": ["Electronics", "Computers & accessories", "Laptop accessories", "Laptop stands"],
    "computers laptoptassen": ["Electronics", "Computers & accessories", "Laptop accessories", "Laptop bags & cases"],
    "computers windows laptops": ["Electronics", "Computers & accessories", "Laptops"],
    "computers accesspoints": ["Electronics", "Computers & accessories", "Networking devices"],
    "computers isdn en adsl": ["Electronics", "Computers & accessories", "Networking devices", "Modems"],
    "computers netwerk switches": ["Electronics", "Computers & accessories", "Networking devices"],
    "computers pc- en netwerkkabels": ["Electronics", "Other devices & accessories", "Cables"],
    "computers powerlines": ["Electronics", "Computers & accessories", "Networking devices", "Network adaptors"],
    "computers wifi-versterkers": ["Electronics", "Computers & accessories", "Networking devices", "Network repeaters"],
    "computers beschrijfbare discs": ["Electronics", "Computers & accessories", "Blank media", "CD, DVD & Blu-ray discs"],
    "computers usb sticks": ["Electronics", "Computers & accessories", "Blank media", "USB flash drives"],
    "computers labelprinters": ["Electronics", "Computers & accessories", "Printers & accessories", "Label printers"],
    "computers pocketprinters": ["Electronics", "Computers & accessories", "Printers & accessories", "Photo printers"],
    "computers printers": ["Electronics", "Computers & accessories", "Printers & accessories"],
    "computers printerbenodigdheden": ["Electronics", "Computers & accessories", "Printers & accessories"],
    "computers 3d printers": ["Electronics", "Other devices & accessories", "3D printing & scanning", "3D printers"],
    "computers 3d-printerbenodigheden": ["Electronics", "Other devices & accessories", "3D printing & scanning"],
    "computers scanners": ["Electronics", "Computers & accessories", "Scanners & accessories", "Scanners"],
    "computers capture cards": ["Electronics", "Computers & accessories", "Computer parts & components", "Video capture & TV tuner cards"],
    "computers dockingstations": ["Electronics", "Computers & accessories", "Docking stations & USB hubs"],
    "computers headsets": ["Electronics", "Audio, headphones & hi-fi", "Headphones & earbuds"],
    "computers joysticks": ["Electronics", "Video games & consoles", "Controllers"],
    "computers monitoren": ["Electronics", "Computers & accessories", "Monitors & accessories", "Monitors"],
    "computers muismatten": ["Electronics", "Computers & accessories", "Mouse pads"],
    "computers muizen": ["Electronics", "Computers & accessories", "Mice"],
    "computers noodvoedingen ups": ["Electronics", "Other devices & accessories", "Batteries & power supplies"],
    "computers optische drives": ["Electronics", "Computers & accessories", "Computer parts & components", "Internal storage devices"],
    "computers pc speakers": ["Electronics", "Computers & accessories", "Computer speakers"],
    "computers presenters": ["Electronics", "Computers & accessories", "Computer accessories", "Other computer accessories"],
    "computers routers en modems": ["Electronics", "Computers & accessories", "Networking devices"],
    "computers toetsenborden": ["Electronics", "Computers & accessories", "Keyboards & accessories", "Keyboards"],
    "computers webcams": ["Electronics", "Computers & accessories", "Webcams"],
    "computers antivirus- en beveiligingssoftware": null,
    "computers audio software": null,
    "computers besturingssoftware": null,
    "computers educatie- en cursussoftware": null,
    "computers navigatiesoftware": null,
    "computers office-software": null,
    "computers ontwerp- en bewerkingssoftware": null,
    "computers android tablets": ["Electronics", "Tablets, e-readers & accessories", "Tablets"],
    "computers apple ipads": ["Electronics", "Tablets, e-readers & accessories", "Tablets"],
    "computers e-readers": ["Electronics", "Tablets, e-readers & accessories", "e-Readers"],
    "computers tablet-hoezen": ["Electronics", "Tablets, e-readers & accessories", "Accessories", "Tablet cases & folios"],
    "computers tekentablets": ["Electronics", "Computers & accessories", "Touch & stylus pads"],
    "computers windows tablets": ["Electronics", "Tablets, e-readers & accessories", "Tablets"],
    "computers overige computers en software": null,
    "sportartikelen badminton": ["Sports", "Racket sports", "Badminton"],
    "sportartikelen basketbal": ["Sports", "Team sports", "Basketball"],
    "sportartikelen bowlen": ["Sports", "Casual sports & games", "Tenpin bowling"],
    "sportartikelen golf": ["Sports", "Golf"],
    "sportartikelen handbal": ["Sports", "Team sports", "Handball"],
    "sportartikelen hockey": ["Sports", "Team sports", "Field hockey"],
    "sportartikelen honkbal en softbal": ["Sports", "Team sports", "Baseball & softball"],
    "sportartikelen korfbal": ["Sports", "Team sports", "Other team sports equipment"],
    "sportartikelen padel": ["Sports", "Racket sports", "Padel"],
    "sportartikelen rugby": ["Sports", "Team sports", "Rugby"],
    "sportartikelen squash": ["Sports", "Racket sports", "Squash"],
    "sportartikelen tafeltennis": ["Sports", "Racket sports", "Table tennis"],
    "sportartikelen tennis": ["Sports", "Racket sports", "Tennis"],
    "sportartikelen voetbal": ["Sports", "Team sports", "Football"],
    "sportartikelen volleybal": ["Sports", "Team sports", "Volleyball"],
    "sportartikelen ballet": null,
    "sportartikelen dansen": null,
    "sportartikelen fitnessapparatuur": ["Sports", "Fitness, running & yoga", "Exercise machines"],
    "sportartikelen fitnessmaterialen": ["Sports", "Fitness, running & yoga", "Strength training"],
    "sportartikelen turnen": ["Sports", "Fitness, running & yoga", "Home fitness accessories"],
    "sportartikelen yoga en pilates": ["Sports", "Fitness, running & yoga", "Yoga & pilates equipment"],
    "sportartikelen bergsport en wandelen": ["Sports", "Outdoor sports"],
    "sportartikelen klimsport": ["Sports", "Outdoor sports", "Climbing & bouldering"],
    "sportartikelen loopsport en atletiek": ["Sports", "Fitness, running & yoga", "Running"],
    "sportartikelen skateboarden": ["Sports", "Skateboards & scooters"],
    "sportartikelen skeelers": null,
    "sportartikelen wielrennen": ["Sports", "Cycling", "Cycling accessories & tools"],
    "sportartikelen biljarten en poolen": ["Sports", "Casual sports & games", "Pool & snooker"],
    "sportartikelen darts": ["Sports", "Casual sports & games", "Darts equipment"],
    "sportartikelen handboogschieten": ["Sports", "Outdoor sports", "Other outdoor sports accessories"],
    "sportartikelen schietsport-accessoires": null,
    "sportartikelen karting": null,
    "sportartikelen paardrijkleding": ["Sports", "Equestrian"],
    "sportartikelen vliegeren": ["Kids", "Toys", "Outdoor & sports toys", "Kites & rockets"],
    "sportartikelen zweefvliegen en paragliding": null,
    "sportartikelen bidons": ["Sports", "Fitness, running & yoga", "Water bottles"],
    "sportartikelen hartslagmeters": ["Electronics", "Wearables", "Fitness trackers"],
    "sportartikelen hoelahoeps": ["Sports", "Fitness, running & yoga", "Home fitness accessories", "Weighted hoops"],
    "sportartikelen springtouwen": ["Sports", "Fitness, running & yoga", "Home fitness accessories", "Skipping ropes"],
    "sportartikelen boksen": ["Sports", "Boxing & martial arts"],
    "sportartikelen vechtsporten en zelfverdediging": ["Sports", "Boxing & martial arts"],
    "sportartikelen duiken": ["Sports", "Water sports", "Swimming"],
    "sportartikelen golfsurfen": ["Sports", "Water sports", "Surfboards"],
    "sportartikelen kitesurfen": ["Sports", "Water sports", "Kitesurf boards"],
    "sportartikelen snorkelen": ["Sports", "Water sports", "Swimming"],
    "sportartikelen suppen": ["Sports", "Water sports", "Stand-up paddle boards"],
    "sportartikelen wakeboarden": ["Sports", "Water sports", "Wakeboards"],
    "sportartikelen waterpolo": ["Sports", "Water sports", "Water sports accessories"],
    "sportartikelen waterski s": ["Sports", "Water sports", "Water skis"],
    "sportartikelen windsurfen": ["Sports", "Water sports", "Water sports accessories"],
    "sportartikelen wingsurfen": ["Sports", "Water sports", "Water sports accessories"],
    "sportartikelen gezondheidsproducten en wellness": null,
    "sportartikelen massageproducten": ["Electronics", "Beauty & personal care electronics", "Massage tools"],
    "sportartikelen sauna": ["Home", "Outdoor & garden", "Spas, pools & equipment", "Saunas"],
    "sportartikelen ijshockey": ["Sports", "Winter sports", "Ice hockey"],
    "sportartikelen schaatsen": null,
    "sportartikelen skien en langlaufen": ["Sports", "Winter sports", "Ski equipment"],
    "sportartikelen snowboarden": ["Sports", "Winter sports", "Snowboard equipment"],
    "sportartikelen overige sport en fitness": null,
    "games accessoires nintendo console": ["Electronics", "Video games & consoles", "Accessories"],
    "games accessoires nintendo portable": ["Electronics", "Video games & consoles", "Accessories"],
    "games accessoires playstation console": ["Electronics", "Video games & consoles", "Accessories"],
    "games accessoires playstation portable": ["Electronics", "Video games & consoles", "Accessories"],
    "games accessoires xbox": ["Electronics", "Video games & consoles", "Accessories"],
    "games accessoires overige": ["Electronics", "Video games & consoles", "Accessories"],
    "games controllers nintendo": ["Electronics", "Video games & consoles", "Controllers"],
    "games controllers playstation": ["Electronics", "Video games & consoles", "Controllers"],
    "games controllers xbox": ["Electronics", "Video games & consoles", "Controllers"],
    "games virtual reality": ["Electronics", "Video games & consoles", "Virtual reality"],
    "electronics telefoon sagem": ["Electronics", "Mobile phones & communication", "Mobile phones"],
    "electronics telefoon siemens": ["Electronics", "Mobile phones & communication", "Mobile phones"],
    "electronics telefoon pda s": ["Electronics", "Tablets, e-readers & accessories", "PDAs"],
    "electronics hoesjes apple iphone": ["Electronics", "Mobile phones & communication", "Mobile phone parts & accessories", "Mobile phone cases"],
    "electronics hoesjes blackberry": ["Electronics", "Mobile phones & communication", "Mobile phone parts & accessories", "Mobile phone cases"],
    "electronics hoesjes htc": ["Electronics", "Mobile phones & communication", "Mobile phone parts & accessories", "Mobile phone cases"],
    "electronics hoesjes nokia": ["Electronics", "Mobile phones & communication", "Mobile phone parts & accessories", "Mobile phone cases"],
    "electronics hoesjes samsung": ["Electronics", "Mobile phones & communication", "Mobile phone parts & accessories", "Mobile phone cases"],
    "electronics hoesjes overige merken": ["Electronics", "Mobile phones & communication", "Mobile phone parts & accessories", "Mobile phone cases"],
    "electronics powerbanks": ["Electronics", "Other devices & accessories", "Power banks"],
    "electronics autoladers": ["Electronics", "Other devices & accessories", "Chargers"],
    "electronics batterijen en accu s": ["Electronics", "Mobile phones & communication", "Mobile phone parts & accessories", "Mobile phone parts"],
    "electronics oordopjes": ["Electronics", "Audio, headphones & hi-fi", "Headphones & earbuds"],
    "electronics pda-toebehoren": ["Electronics", "Mobile phones & communication", "Mobile phone parts & accessories", "Other mobile phone accessories"],
    "electronics prepaidkaarten en simkaarten": null,
    "electronics telefoonsoftware": null,
    "electronics telefoon-opladers": ["Electronics", "Other devices & accessories", "Chargers"],
    "electronics telefoonhouders": ["Electronics", "Mobile phones & communication", "Mobile phone parts & accessories", "Mobile phone mounts & stands"],
    "electronics toebehoren en onderdelen": ["Electronics", "Mobile phones & communication", "Mobile phone parts & accessories", "Mobile phone parts"],
    "electronics antwoordapparaten": ["Electronics", "Mobile phones & communication", "Landline phones"],
    "electronics draadloze handsets": ["Electronics", "Mobile phones & communication", "Landline phones"],
    "electronics niet-draadloze handsets": ["Electronics", "Mobile phones & communication", "Landline phones"],
    "electronics telefooncentrales": null,
    "electronics wearable-accessoires": ["Electronics", "Wearables"],
    "electronics datacommunicatie": null,
    "electronics faxen": ["Electronics", "Mobile phones & communication", "Fax machines"],
    "electronics antennes en masten": null,
    "electronics portofoons en walkie-talkies": ["Electronics", "Mobile phones & communication", "Radio communication", "Walkie-talkies"],
    "electronics radioscanners": null,
    "electronics zenders en ontvangers": null,
    "electronics carkits": null,
    "electronics overige telecommunicatie": null,
  };
  ...
  function vintedPathFor(cat, gender) {
    // Takken buiten kleding met een vast pad (zie V_PAD): dat pad, los van
    // doelgroep. null (geen rubriek op Vinted) wordt in fillCategoryVinted al
    // eerder afgevangen.
    if (Object.prototype.hasOwnProperty.call(V_PAD, cat)) return V_PAD[cat] || null;
  ...
  async function fillCategoryVinted(item) {
    ...
    // Vinted heeft voor deze rubriek geen plek (V_PAD null). Niet zoeken en een
    // naastgelegen blad pakken, maar stoppen met een reden die de verkoper snapt.
    if (Object.prototype.hasOwnProperty.call(V_PAD, cat) && V_PAD[cat] === null) {
      throw new Error(`Vinted has no category for "${cat}" — this item can't be listed on Vinted. It was not published there.`);
    }
    ...
    const NIET_KLEDING_TAK = /^(wonen|antiek|kunst|muziek|sieraden|games|electronics|audio|boeken|speelgoed|fietsen|witgoed|klussen|computers|sportartikelen)\b/;
