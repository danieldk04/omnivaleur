...
_Laatst bijgewerkt: 26-09-2026 (Verzendkosten op 2dehands: standaard blijft Bpost EUR 7,10, want het Marktplaats-bedrag is een Nederlandse prijs en een pakje naar België kost meer; per klant kan Daniel voor artikelen met een bepaald woord in de titel het eigen Marktplaats-bedrag laten overnemen, werkt vanaf uitbreiding 1.0.354. Die omzettingen staan niet meer in de wachtrij op het dashboard, want daar leek de rij vast te zitten. Eerder, 24-09: Het dashboard kan nu in het Nederlands: linksonder in het menu, boven Log out, staat EN · NL; standaard blijft het Engels. Eerder dezelfde dag: Nieuwe soorten artikelen: boeken en strips, speelgoed en spellen (ook Lego, Pokémonkaarten, modeltreinen), fietsen en fietsaccessoires, sportartikelen, witgoed en keukenapparaten, gereedschap en klusspullen, computers en tablets, en bij games en telefoons nu ook accessoires en controllers; werkt vanaf extensie 1.0.351. De staat van een artikel uit Vinted klopt nu: Goed is Used, niet Like new. Eerder dezelfde dag, Import: vink aan op welke kanalen je verkoopt en druk op een knop; alles wordt ingelezen, alleen zekere overeenkomsten worden vanzelf gekoppeld, twijfelgevallen staan met beide foto's klaar om te kiezen, en daarna wordt de hele voorraad op dubbelen nagelopen. Eerder, 23-09: bestaande Shopify-producten zijn nu in te lezen via Import. Eerder, 22-09: een advertentie in een DERDE taal komt niet langer onvertaald op Marktplaats of 2dehands: de taalherkenning kende alleen Nederlands en Engels, dus een Duitse tekst met een Nederlands winkelblok eronder telde als "staat al in het Nederlands" en werd overgeslagen. Duitse teksten worden nu gewoon vertaald. Eerder dezelfde dag: het publiceervenster waarschuwt voortaan vooraf als 2dehands is aangevinkt terwijl er in Preferences geen land en woonplaats staan: 2dehands zet op elk zoekertje een adres en haalt dat uit het account op 2dehands.be, waar alleen een Belgische postcode in past. Wie niet in Belgie woont liep daardoor op elke plaatsing vast en hoorde het pas achteraf. Het is een waarschuwing, geen blokkade: een Belgische verkoper met een postcode in zijn account hoeft daar niets in te vullen. Eerder dezelfde dag: de rubriekenlijst "Category" in het bewerkscherm is voortaan altijd compleet: Item type en Gender bepalen alleen nog welke groep bovenaan staat, alle andere groepen staan eronder met de groep ervoor. Item type staat nu ook vlak boven Category in plaats van bovenaan het formulier. Eerder dezelfde dag: smartwatches op Marktplaats: daar mogen er maar twee gratis in de rubriek Smartwatches staan; vanaf de derde zet Omnivaleur ze nu vanzelf in Sporthorloges, waar die grens niet geldt, in plaats van ze over te slaan. Eerder dezelfde dag: de rubriekenlijst in het bewerkscherm toont voortaan alle rubrieken, ook als er al een doelgroep op het artikel staat: wie een vacht, kleed of tafelkleed had en "heren" of "dames" op het artikel, zag alleen kledingrubrieken en kwam er niet uit. Opslaan zonder iets te wijzigen meldt niet langer "Item saved". Nieuw: vink meerdere artikelen aan en gebruik "Change category..." om ze in een keer in dezelfde rubriek te zetten; de doelgroep gaat daarbij vanzelf mee (kleding) of eraf (wonen, antiek, muziek). Eerder, 19-09: een advertentie die op Marktplaats of 2dehands vanzelf verlopen is levert geen vraag "is dit verkocht?" meer op: zo'n advertentie staat op zijn eigen pagina nog gewoon met VERLOPEN erop, dus wie de melding natrok zag hem staan; verlopen advertenties gaan nu meteen naar het archief en de vragen die er al stonden worden vanzelf opgeruimd, uitbreiding 1.0.341. Eerder dezelfde dag: de vraag "is dit verkocht?" kan nu uit, bij Preferences onder Upkeep: voor wie nieuwe voorraad verkoopt is een verdwenen advertentie geen verkoopsignaal, en dan gaat zo'n advertentie meteen naar het archief zonder vraag en zonder mail, terwijl er nergens anders iets wordt weggehaald. Eerder, 18-09: het werk-tabblad blijft nu bij alles wat we invullen op vol tempo lopen, ook als je er niet bij zit en ook nadat de pagina wisselt: plaatsen, verwijderen, verlengen en tekst bijwerken, op elk kanaal, uitbreiding 1.0.340; Vinted opent daarbij geen apart venster meer maar een tabblad in je eigen venster; loafers, mocassins en bootschoenen worden niet langer als nette schoenen ingedeeld. Let op: we plaatsen per kanaal om de beurt en een voor een, dus vier kanalen kosten al gauw een kwartier per artikel; dat is geen storing. Eerder dezelfde dag: de melding dat de server niet op tijd antwoordde (502) bij publiceren komt van een nieuwe versie die net live gaat: Marktplaats, 2dehands en Vinted lopen daarna gewoon door en Shopify en eBay maken zichzelf binnen tien minuten af; het plaatsformulier blijft nu ook op Marktplaats en 2dehands op vol tempo doorlopen in een tabblad dat niet in beeld staat, uitbreiding 1.0.339; een artikel dat je opnieuw inkoopt onder hetzelfde nummer wordt niet langer samengevoegd met het exemplaar dat al verkocht was, en verdwijnt dus niet meer onder Verkocht; een tweede exemplaar met een eigen nummer zoals 1349 - 2 wordt herkend en kan gewoon geplaatst worden. Eerder dezelfde dag: advertenties in een rubriek die op 2dehands geld kost werden keer op keer opnieuw geprobeerd doordat de fouttekst van zo'n mislukking kon verdwijnen; die tekst blijft nu staan, zo'n rubriek wordt onthouden en de rest van de wachtrij loopt door. Eerder dezelfde dag: 2dehands ging bij een klant helemaal uit omdat één advertentie in een betalende rubriek op de bestelpagina uitkwam; dat gebeurt niet meer, voortaan stopt alleen die rubriek en blijft de rest van de wachtrij lopen. Eerder dezelfde dag: de knop 'Clear queue' leegt nu de hele wachtrij in een klik en toont het echte aantal; hij ruimde er maximaal 50 per klik op terwijl de teller ook op 50 bleef staan, dus bij een lange rij leek er niets te gebeuren. Eerder, 17-09: nieuwe klanten zien op hun dashboard een lijst 'Get started' die vanzelf afvinkt wat echt gelukt is, en Help in het dashboard legt met een schema uit hoe het werkt, wat de iconen betekenen en wat je per kanaal nodig hebt; op Platforms staat niet langer 'Auto-detected' maar 'Uses your Chrome login'; Vinted: te lange omschrijvingen worden voor Vinted zelf ingekort en de staat wordt opnieuw ingevuld als dat de eerste keer mislukt, extensie 1.0.338; Facebook meldt alleen nog klaar als Facebook het bevestigt; vervangen bij een zakelijk Marktplaats- of 2dehands-account wordt niet meer aangeboden; een verkoop wordt alleen nog op een kanaal geboekt als dat kanaal het zelf zegt of de klant het bevestigt: een advertentie die uit je Vinted-kast verdwenen is, wordt een vraag in het dashboard waarbij je zelf het kanaal aanwijst; een klik op een grijs kanaalicoon plaatst nu of vraagt de link, en zet niets meer zomaar op live; opslaan in het bewerkscherm zet niets meer terug wat de klant zelf niet veranderde, en een artikel met Bieden, Zie omschrijving of Gratis kan weer worden opgeslagen zonder bedrag; verkocht op Marktplaats of 2dehands met een zakelijk account wordt nu ook opgemerkt als vraag in het dashboard; 2dehands voor verkopers die in Nederland wonen: land en woonplaats invullen bij Preferences; al op een kanaal en net bewerkt: vervangen kan nu direct vanuit het publiceervenster. Eerder, 15-09: zakelijk account lijkt op uitgelogd; eBay in het Nederlands; wachtrij die stilstaat omdat de browser niet is ingelogd; Vinted plaatst door zonder open tabblad; rode 'Relist failed' meldingen hersteld in 1.0.334)_
...
- Verzendkosten op 2dehands (bijgewerkt 26-09-2026, uitbreiding 1.0.354):
  standaard krijgt elk zoekertje Bpost 0 tot 2 kg voor EUR 7,10. Het bedrag dat
  de klant op Marktplaats bij "Zelf verzenden" zet is een Nederlandse prijs, en
  een koper op 2dehands woont meestal in België. Voor een brief scheelt dat
  ongeveer een euro, voor een pakje veel meer (Egbert: EUR 4,95 in Nederland,
  EUR 9,50 naar België). Wil een klant voor sommige artikelen toch zijn eigen
  Marktplaats-bedrag op 2dehands, bijvoorbeeld voor iets dat als brief gaat, dan
  stelt Daniel dat voor hem in met een woord uit de titel (bij Egbert: "patch").
  Alleen artikelen met dat woord die op Marktplaats "Zelf verzenden" met een
  bedrag hebben, krijgen op 2dehands "Zelf versturen" met hetzelfde bedrag; al
  het andere houdt Bpost. Verzendt de klant op Marktplaats via Marktplaats zelf
  (PostNL of DHL), dan blijft het ook Bpost. Zoekertjes die al online staan zet
  Omnivaleur op de achtergrond om zodra de uitbreiding is bijgewerkt. Die
  omzettingen staan niet in de wachtrij op het dashboard en "Clear queue" haalt
  ze niet weg. Een ander bedrag willen: eerst op Marktplaats aanpassen, daarna
  op 2dehands plaatsen.
