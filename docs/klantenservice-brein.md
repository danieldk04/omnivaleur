...
- Verzendkosten op 2dehands (sinds 26-09-2026, uitbreiding 1.0.353): staat een
  ...
  dan blijft het Bpost 0 tot 2 kg. Zoekertjes die al op 2dehands stonden
  veranderen niet vanzelf; die past de klant op 2dehands aan via Wijzig. Een
  ander bedrag willen: eerst op Marktplaats aanpassen, daarna op 2dehands
  plaatsen.
