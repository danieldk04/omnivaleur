...
- Staan je producten al in Shopify? Ga naar Import, klik bij Shopify op Scan, en je
  winkel wordt ingelezen: titel, prijs, foto's, omschrijving, merk en maat. Wat al in
...
- Importeren vanuit Shopify bestaat nog niet (het importscherm zegt "Coming
  soon"). Wie zijn voorraad in Shopify heeft en op Marktplaats adverteert,
  importeert via Marktplaats; met een zakelijk account via de schakelaar
  "Business account (Admarkt)". Omnivaleur werkt met één account per kanaal.
