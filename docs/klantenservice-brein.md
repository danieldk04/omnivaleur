...
- Verzendkosten op 2dehands (sinds 26-09-2026, uitbreiding 1.0.354): staat een
  artikel al op Marktplaats met "Zelf verzenden" en een eigen bedrag, dan komt
  het op 2dehands met "Zelf versturen" en precies dat bedrag. Daarvoor kreeg
  elk zoekertje Bpost 0 tot 2 kg voor EUR 7,10, ook een patch die de klant op
  Marktplaats voor EUR 2,95 verstuurt. Verzendt de klant op Marktplaats via
  Marktplaats zelf (PostNL of DHL), of staat het artikel niet op Marktplaats,
  dan blijft het Bpost 0 tot 2 kg. Ging een zoekertje toch met Bpost online
  (oudere uitbreiding), dan zet Omnivaleur het daarna vanzelf om zodra de
  uitbreiding is bijgewerkt; de klant ziet dan een korte bijwerking in de
  wachtrij. Zoekertjes die al van vóór 26-09 op 2dehands stonden veranderen
  niet vanzelf; wil de klant die ook omzetten, dan kan Daniel dat in een keer
  laten doen. Een ander bedrag willen: eerst op Marktplaats aanpassen, daarna
