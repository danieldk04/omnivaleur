...
kenburns_clip(REAL / "01_dashboard.webm", 5.0, 2.0,
              rect0=(270, 30, 540), rect1=(270, 30, 480),
              out=WORK / "10_dash_a.mp4")
kenburns_clip(REAL / "01_dashboard.webm", 7.0, 1.7,
...
kenburns_clip(REAL / "02_items.webm", 4.8, 2.0,
...
kenburns_clip(REAL / "03_platforms.webm", 5.0, 1.8,
...
kenburns_clip(REAL / "04_analytics.webm", 5.2, 1.8,
              rect0=(270, 130, 470), rect1=(270, 130, 410),
              out=WORK / "40_an_a.mp4")
kenburns_clip(REAL / "04_analytics.webm", 7.0, 1.2,
...
kenburns_clip(REAL / "05_calculator.webm", 6.0, 2.2,
